	******************************************************
	****     Sierra AGI replayer for EaglePlayer      ****
	...
	******************************************************
	...
	dc.b	'$VER: Sierra AGI player module V1.0 (14 Jan 2006)',0
	even
Tags
	...
	dc.l	EP_Flags,EPB_LoadFast!EPB_Save!EPB_Volume!EPB_Balance!EPB_ModuleInfo!EPB_Voices!EPB_Songend!EPB_Analyzer!EPB_Packable!EPB_Restart
	dc.l	0
...
lbC00EC00	MOVE.L	lbL00EF4C(pc),(A4)	; address
...
lbC00EC0C	MOVE.W	8(A5),6(A4)		; period
...
lbC00F5EE	MOVE.L	_waveForm(pc),(A4)	; address
