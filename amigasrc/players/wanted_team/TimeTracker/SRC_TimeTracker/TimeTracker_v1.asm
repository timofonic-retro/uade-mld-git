	******************************************************
	****     TimeTracker replayer for EaglePlayer     ****
	...
	******************************************************
	...
	dc.b	'$VER: TimeTracker player module V1.0 (7 Mar 2014)',0
	even
...
lbC0031D8	BTST	#6,($1E,A6)
	BNE.B	lbC0031E4
	CLR.B	($1D,A6)
lbC0031E4	MOVE.L	(4,A6),(A4)		; address
...
lbC003262	MOVE.W	($10,A6),(6,A4)		; period
...
lbC0032C4	MOVE.W	D2,(6,A4)		; period
...
lbC00343A	MOVE.W	D2,(6,A4)		; period
...
lbC0034C4	MOVE.W	D0,(6,A4)		; period
...
lbC0034E6	MOVE.W	($10,A6),(6,A4)		; period
...
lbC0035C6	MOVE.W	($10,A6),(6,A4)		; period
