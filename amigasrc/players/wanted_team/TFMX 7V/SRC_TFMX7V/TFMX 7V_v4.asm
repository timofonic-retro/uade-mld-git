...
HIGHEST_MIXING_RATE	equ	28
	...
	dc.b	'$VER: TFMX 7V player module V1.3 (6 May 2010)',0
	even
Tags
...
PlayerName
	dc.b	'TFMX 7V',0
Creator
	dc.b	'(c) 1991-94 by Chris Hülsbeck & Jochen',10
...
cbk1a
	...
	bpl.s	clvc2a			; 8/12
cbk2a
	add.l	v7field+v7freq3(PC),D2	; 18
	addx.w	D4,D2			; 4
	bpl.s	clvc3a			; 8/12
cbk3a
	add.l	(SP),D3			; 14
