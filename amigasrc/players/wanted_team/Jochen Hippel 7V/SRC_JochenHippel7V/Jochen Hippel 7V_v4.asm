...
HIGHEST_MIXING_RATE	equ	29
	...
	dc.b	'$VER: Jochen Hippel 7V player module V1.3 (17 May 2014)',0
	even
Tags
...
cbk4
	...
	sub.l	D4,D5			; 6
	bcc.w	calc1			; 10
	bra.w	clcback			; total minimum 508 cycles (56 commands)
					; total minimum 254 cycles per mixed byte
			; original version total minimum 268 cycles (32 commands)

* if using
*	add.l	SP,D3			; 6   stack as simple register
* no-OS friendly version minimum 246 cycles per byte, it's 22 cycles fastest
