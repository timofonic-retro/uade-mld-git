	...
	*****************************************************
	...
	dc.b	'$VER: Quartet ST player module V1.2 (29 Aug 2009)',0
	even
Tags
...
NoBit
	cmp.l	#83230,D0
	blt.b	NoAmiga
	cmp.l	#'HfR0',760(A0)			; Projectyle Amiga samples
	bne.b	NoAmiga
	cmp.l	#'MP7E',13588(A0)
	bne.b	NoAmiga
	st	1(A6)
