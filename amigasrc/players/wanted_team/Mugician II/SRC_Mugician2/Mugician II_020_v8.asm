	*****************************************************
	**** Mugician II 68020+ replayer for EaglePlayer,****
...
HIGHEST_MIXING_RATE	equ	29
	...
	dc.b	'$VER: Mugician II player module V1.7 [68020+] (3 May 2014)',0
	even
Tags
...
NoMemory
	clr.l	OtherSize(A4)
	move.l	ModulePtr(PC),(A2)		; for relocation
Skipper
	lea	Tables(PC),A0
	tst.w	(A0)
	bne.b	InitDone
...
;	MOVE.W	#0,lbW010AC8
	...
	move.l	lbL00FF8E(PC),D0
	beq.b	lbC00FDD6
	sub.l	ModulePtr(PC),D0
	add.l	FastPtr(PC),D0
	move.l	D0,lbL010AD0
	move.l	lbL00FF92(PC),D0
	sub.l	ModulePtr(PC),D0
	add.l	FastPtr(PC),D0
	move.l	D0,lbL010AE0
	move.l	lbL00FF96(PC),lbL010AF0
...
Top
	swap	D1			; 4 to data
	move.b	(A1),D6			; 8
	move.w	Tables(PC,D6.W*2),D1 	; 12
	swap	D6			; 4
	move.b	(A0),D6			; 8
	add.w	Tables(PC,D6.W*2),D1 	; 12
	move.b	(A3),D0			; 8
	add.w	Tables(PC,D0.W*2),D1 	; 12
	swap	D0			; 4
	move.b	(A2),D0			; 8
	add.w	Tables(PC,D0.W*2),D1	; 12
	move.w	Tables(PC,D1.W*2),D1	; 12
	clr.w	D5			; 2
	add.l	A5,D2			; 2
	addx.w	D5,D2			; 2
	add.w	D2,A0			; 2
	...
	add.w	D5,A3			; 2
	move.b	(A0),D6			; 8
	move.w	Tables(PC,D6.W*2),D5	; 12
	swap	D6			; 4
	move.b	(A1),D6			; 8
	add.w	Tables(PC,D6.W*2),D5	; 12
	move.b	(A2),D0			; 8
	add.w	Tables(PC,D0.W*2),D5 	; 12
	swap	D0			; 4
	move.b	(A3),D0			; 8
	add.w	Tables(PC,D0.W*2),D5 	; 12
	move.b	Tables(PC,D5.W*2),D1	; 12
	move.w	D1,(A4)+		; 28
	clr.w	D5			; 0 (2/24)
	add.l	A5,D2			; 0 (4/24)
	addx.w	D5,D2			; 0 (6/24)
	...
	clr.w	D2			; 0 (10/24)
	add.l	A6,D3			; 0 (12/24)
	addx.w	D5,D3			; 0 (14/24)
	add.w	D3,A1			; 0 (16/24)
	add.l	D7,D4			; 0 (18/24)
	addx.w	D5,D4			; 0 (20/24)
	add.w	D4,A2			; 0 (22/24)
	swap	D1			; 2 (24/24) to dbf
	dbf	D1,Loop			; 6
					; total 322 cycles (58 commands)
					; total 161 cycles per mixed byte
	bra.w	Return
