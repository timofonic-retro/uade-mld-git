	...
	******************************************************
	...
	dc.b	'$VER: Adaptative Delta Pulse Code Modulation player module V1.1 (29 Sep 2014)',0
	even
Tags
	...
	dc.l	EP_Flags,EPB_LoadFast!EPB_ModuleInfo!EPB_Songend!EPB_Packable!EPB_Restart!EPB_CalcDuration
...
PlayerName
	dc.b	'Adaptative Delta Pulse Code Modulation',0
Creator
